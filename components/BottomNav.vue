          ...
          >
           <v-layout
            ...
            <v-card
              flat
              tile
              class="orange accent-3 white--text text-xs-center navCard"
            >
              <v-card-text>
                <v-btn
...
<script>
  export default {
    data() {
      return {
        icons: [
          {icon:'fab fa-facebook', link:'https://www.facebook.com/Mtlj1991'},
          {icon:'fab fa-twitter', link:'https://twitter.com/Mtlj1991'},
          {icon:'fab fa-linkedin', link:'https://www.linkedin.com/in/matt-jones-a97530146/'},
          {icon:'fab fa-instagram', link:'https://www.instagram.com/mtlj1991/'},
        ],
        clipped: false,
        drawer: true,
        fixed: false,
